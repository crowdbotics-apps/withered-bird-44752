"""
Django settings for withered_bird_44752 project.
...
ROOT_URLCONF = 'withered_bird_44752.urls'
...
WSGI_APPLICATION = 'withered_bird_44752.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "withered_bird_44752 API",
    "DESCRIPTION": "API documentation for withered_bird_44752 App",
    "VERSION": "v1",
}
